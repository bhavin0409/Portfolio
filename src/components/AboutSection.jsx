                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center'>
                    <div className='space-y-4 sm:space-y-6'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 justify-center sm:justify-start'>
                            ...
                            <a href="/Bhavin_RESUME.pdf" target='_blank' className='px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/30 transition-colors duration-300 w-full sm:w-auto text-center'>Download CV</a>
                        </div>
                    </div>
